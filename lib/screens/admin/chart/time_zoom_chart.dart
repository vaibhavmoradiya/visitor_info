...
class TimeZoomChart extends StatefulWidget {
  const TimeZoomChart({Key? key}) : super(key: key);

  @override
  _TimeZoomChartState createState() => _TimeZoomChartState();
}

class _TimeZoomChartState extends State<TimeZoomChart> {
  List<LineSeries<Data, DateTime>> _seriesBarData = [];
  List<Data>? mydata;
